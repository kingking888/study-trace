...
namespace nim_comp {
    ...
    class CefControlBase : public Control, public nim_comp::BrowserHandler::HandlerDelegate {
      ...
      public:
        ...
        */
        virtual bool IsAttachedDevTools() const {
            return devtool_attached_;
        }
      ...
      public:
        ...
        */
        void AttachBeforeNavigate(const OnBeforeResourceLoadEvent& callback) {
            cb_before_resource_load_ = callback;
        }
        ...
        */
        void AttachDevToolAttachedStateChange(const OnDevToolAttachedStateChangeEvent& callback) {
            cb_devtool_visible_change_ = callback;
        };
        ...
        * @return 无
        */
        void AttachAfterCreated(const OnAfterCreatedEvent& callback) {
            cb_after_created_ = callback;
        }
        ...
        * @return 无
        */
        void AttachBeforeCLose(const OnBeforeCloseEvent& callback) {
            cb_before_close_ = callback;
        }
        ...
        * @return 无
        */
        void AttachBeforeBrowser(const OnBeforeBrowserEvent& callback) {
            cb_before_browser_ = callback;
        }
        ...
        */
        void AttachProtocolExecution(const OnProtocolExecutionEvent& callback) {
            cb_protocol_execution_ = callback;
        }
        ...
        * @return 无
        */
        void AttachFileDialog(const OnFileDialogEvent& callback) {
            cb_file_dialog_ = callback;
        }
