...
class MultiBrowserForm : public nim_comp::ShadowWndBase, public IDropTarget, public TaskbarManager::ITaskbarDelegate {
  ...
  public:
    ...
    */
    virtual HDC GetRenderDC() const override {
        return this->GetRenderContext()->GetDC();
    };
    ...
    * @return void	无返回值
    */
    virtual void CloseTaskbarItem(const std::string& id) override {
        CloseBox(id);
    }
    ...
    * @return void 无返回值
    */
    virtual void SetActiveTaskbarItem(const std::string& id) override {
        SetActiveBox(id);
    }
